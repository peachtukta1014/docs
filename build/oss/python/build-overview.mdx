...
<div class="home-page mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <Card
          ...
          cta="Install and run"
          href="/oss/python/python/deepagents/code/overview"
          icon="terminal"
        >
        ...
        <Card
          ...
          href="/oss/python/python/integrations/providers/overview"
          icon="plug"
        >
        ...
        <Card
          title="Reference"
          cta="View reference"
          href="/oss/python/python/reference/overview"
          icon="code"
        >
        ...
        <Card
          ...
          href="/oss/python/python/contributing/overview"
          icon="heart-plus"
        >
