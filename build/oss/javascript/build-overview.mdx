...
<div class="home-page mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <Card
          title="Deep Agents"
          cta="Get started"
          href="/oss/javascript/javascript/deepagents/overview"
        ...
        <Card
          title="LangChain"
          cta="Get started"
          href="/oss/javascript/javascript/langchain/overview"
        ...
        <Card
          title="LangGraph"
          cta="Get started"
          href="/oss/javascript/javascript/langgraph/overview"
        ...
        <Card
          ...
          cta="Install and run"
          href="/oss/javascript/javascript/deepagents/code/overview"
          icon="terminal"
        >
        ...
        <Card
          ...
          href="/oss/javascript/javascript/integrations/providers/overview"
          icon="plug"
        >
        ...
        <Card
          title="Learn"
          cta="View tutorials"
          href="/oss/javascript/javascript/learn"
          icon="book"
        >
        ...
        <Card
          title="Reference"
          cta="View reference"
          href="/oss/javascript/javascript/reference/overview"
          icon="code"
        >
        ...
        <Card
          ...
          href="/oss/javascript/javascript/contributing/overview"
          icon="heart-plus"
        >
